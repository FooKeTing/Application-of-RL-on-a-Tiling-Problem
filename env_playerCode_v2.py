...
class squarestate(playernum, Env):
    ...
    def step(self,action):
        ...
        if action == UP:
            # randomly choose whether to move one step or multiple step at a time
            moveSteps = random.randint(1,self.promptNum)
            
            for curr_position in self.player_positionList:
                # calculate new player position
                new_position = curr_position - (self.newCols * moveSteps)
            ...
            for curr_position in self.player_positionList:
                # calculate new player position
                new_position = curr_position - (1 * moveSteps)
            ...
            for curr_position in self.player_positionList:
                # calculate new player position
                new_position = curr_position - ((self.newCols + 1) * moveSteps)
